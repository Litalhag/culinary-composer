...
// @access    Public
export const GetUserRecipes = asyncHandler(async (req, res, next) => {
...
// @access    Public
export const GetUserRecipe = asyncHandler(async (req, res, next) => {
...
// @access    Private
export const CreateByText = asyncHandler(async (req, res, next) => {
  ...
  try {
    ...
    const recipe = await Recipe.create({recipeText, revisedPromptDescription, revisedPromptURL});
      res.status(200).json({
        success: true,
